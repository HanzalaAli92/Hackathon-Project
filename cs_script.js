...
let start_resume = document.getElementById("start-action");
let edit_resume = document.getElementById("edit-action");
let download_resume = document.getElementById("download-action");
let resume_form_container = document.getElementById("resume-form-container");
let action_buttons = document.getElementById("action-buttons");
let resume_display = document.getElementById("resume-display");
...
let work = document.getElementById('work-experience');
let education = document.getElementById('education-background');
let submit_btn = document.getElementById('generate-btn');
// Declare a variable to hold resume data
let resume;
// Get references to HTML elements where resume data will be displayed
let table_name = document.getElementById('resume-name');
let table_email = document.getElementById('resume-email');
let table_phone = document.getElementById('resume-phone');
let table_address = document.getElementById('resume-address');
let table_profile_summary = document.getElementById('resume-summary');
let table_skills = document.getElementById('resume-skills');
let table_work_exp = document.getElementById('resume-work');
let table_education = document.getElementById('resume-education');
